...
export const WrenchIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M14.125 10.875l-6 6l-1.125 -1.125l6 -6l1.125 1.125z" />
        <path d="M12.89 19.14l-4.13 -4.13a4.5 4.5 0 1 1 6.36 -6.36l4.13 4.13a4.5 4.5 0 1 1 -6.36 6.36z" />
    </svg>
);
...
export const CarIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M2 10h20" />
    <path d="M6 10V6.5a2.5 2.5 0 0 1 5 0V10" />
    <path d="m18 10-2-6" />
    <path d="M4 10 2 4" />
    <path d="M12 10V5" />
...
export const ToolIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
